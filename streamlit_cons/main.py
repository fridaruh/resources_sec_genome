...
stakeholder = st.selectbox('¿A qué stakeholder pertenece la señal?',('Academia','Acedamia y Startup',
                                                                     'Empresa Privada','Gobierno','Grupos de poder',
                                                                     'Hospital','Individuo','Startups'))
